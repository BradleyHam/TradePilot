// Plain-ESM twin of add-trademax-5653-bill.ts — runs with `node` directly
// (no tsx/esbuild), so it works in the Linux agent sandbox as well as on the
// Mac. Pulls Trademax invoice WANAKA-5653 ($475.51) into TradePilot as a
// draft bill so it can be allocated to a job and matched against the 18 May
// $475.51 bank payment.
//
// Source: Gmail — Xero invoice "WANAKA - 5653" (thread 19de099e37665d24) +
// itemised receipt #5653 (thread 19d8df6a95c6b6f0): subtotal $413.49,
// GST $62.02, total $475.51, issued 15 Apr 2026, due 20 May 2026.
//
//   node scripts/add-trademax-5653-bill.mjs            # dry-run
//   node scripts/add-trademax-5653-bill.mjs --apply    # write
